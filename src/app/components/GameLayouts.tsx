    ...
    <>
      ...
      {xpPenaltyBanner && (
        <div style={{ position: "fixed", top: "35%", left: "50%", zIndex: 9500, pointerEvents: "none", textAlign: "center", animation: "penaltyDrop 3s ease forwards", transform: "translate(-50%,-50%)" }}>
          ...
          <div style={{ fontFamily: "'Press Start 2P', monospace", fontSize: 22, color: "#E63946", textShadow: "3px 3px 0 #000, 0 0 20px rgba(230,57,70,0.6)", letterSpacing: 2, lineHeight: 1.3 }}>DESAFIO FALHOU!</div>
          ...
          <div style={{ fontFamily: "'VT323', monospace", fontSize: 18, color: "#ff8888", marginTop: 6, textShadow: "1px 1px 0 #000" }}>50% do progresso do nível perdido</div>
        </div>
      )}
      {attackBanner && (
