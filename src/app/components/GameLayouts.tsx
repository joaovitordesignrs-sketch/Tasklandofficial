...
export function DesktopLayout() {
  ...
  const { BG_PAGE, COLOR_DANGER, FONT_PIXEL, FONT_BODY } = useTheme();
    ...
    <>
      ...
      {xpPenaltyBanner && (
        <div style={{ position: "fixed", top: "35%", left: "50%", zIndex: 9500, pointerEvents: "none", textAlign: "center", animation: "penaltyDrop 3s ease forwards", transform: "translate(-50%,-50%)" }}>
          ...
          <div style={{ fontFamily: FONT_PIXEL, fontSize: 22, color: COLOR_DANGER, textShadow: "3px 3px 0 #000, 0 0 20px rgba(230,57,70,0.6)", letterSpacing: 2, lineHeight: 1.3 }}>CHALLENGE FAILED!</div>
          ...
          <div style={{ fontFamily: FONT_BODY, fontSize: 18, color: "#ff8888", marginTop: 6, textShadow: "1px 1px 0 #000" }}>50% of level progress lost</div>
        </div>
      )}
      {attackBanner && (
        <div style={{ position: "fixed", top: "38%", left: "50%", zIndex: 9000, pointerEvents: "none", textAlign: "center", animation: "bannerPop 1.4s ease forwards", transform: "translate(-50%,-50%)" }}>
          ...
          <div style={{ fontFamily: FONT_PIXEL, fontSize: attackBanner.size, color: attackBanner.color, textShadow: "3px 3px 0 #000", letterSpacing: 2, lineHeight: 1.2, whiteSpace: "nowrap", animation: attackBanner.text.includes("CRITICAL") ? "criticalPulse 0.4s step-end infinite" : "none" }}>{attackBanner.text}</div>
...
export function MobileLayout() {
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100dvh", background: BG_PAGE, animation: screenShake ? "missionScreenShake 0.4s ease" : "none" }}>
